...
<head>
    ...
    <title>Floating Category Menu with Search</title>
    ...
    <style>
        ...
        /* Custom styles for submenu items */
        .submenu {
            display: none;
        }
        .submenu.visible {
...
<body class="bg-gray-100 min-h-screen">
    <!-- Floating Menu Button - Positioned at center left -->
    <div class="fixed left-6 top-1/2 transform -translate-y-1/2 z-40">
        <button id="menuButton" class="w-14 h-14 rounded-full bg-blue-600 text-white flex items-center justify-center shadow-lg hover:bg-blue-700 transition-all duration-300">
            <i class="fas fa-bars text-xl"></i>
        </button>
    </div>

    <!-- Overlay -->
    <div id="overlay" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden opacity-0 transition-opacity duration-300"></div>

    <!-- Category Menu -->
    <div id="categoryMenu" class="fixed inset-0 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg shadow-xl w-11/12 max-w-4xl h-5/6 category-menu fade-in">
            ...
            <div class="p-4 border-b">
                <div class="relative">
                    <input type="text" id="searchInput" placeholder="Search categories..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
            ...
            <div class="p-4 overflow-y-auto">
                <div id="menuContent" class="space-y-2">
    ...
    <script>
        // Floating Category Menu with Search - JavaScript Implementation
        // Copy this code to a .js file and upload to GitHub
        ...
        (function() {
            ...
            // Configuration
            const config = {
                menuButtonPosition: 'left', // 'left' or 'right'
                menuButtonColor: '#2563eb', // blue-600
                menuButtonHoverColor: '#1d4ed8', // blue-700
